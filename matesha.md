Готово! Ниже — **более детализированная, «по каждому методу»** выжимка с формулами и параметрами (только про умножение **целых** чисел). В конце — ссылка на подготовленный **PDF‑конспект** для 30‑минутного доклада.
